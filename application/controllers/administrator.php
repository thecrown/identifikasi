...
/***********************************************************************/ //contructor
    public function index() {
        ...
        $this->load->view('admin/menu', $data1);
...
/***********************************************************************/ //
    public function pengaturanakun($id) {
        $data1['username'] = $session_data = $this->session->userdata('username');
        // $data1['id'] = $session_data = $this->session->userdata('id');
...
/***********************************************************************/ //
    function inputkategori()
    {
        ...
        $this->load->view('admin/head');
        $this->load->view('admin/menu', $data1);
        $this->load->view('admin/inputkategori');
    }
...
function inputsparepart()
    {
        ...
        $this->load->view('admin/head');
        $this->load->view('admin/menu', $data1);
        $this->load->view('admin/inputsparepart');
    }
...
function simpansparepart() {
 ...
 /***********************************************************************/ //
     function inputjeniskendaraan()
    {
        ...
        $this->load->view('admin/head');
        $this->load->view('admin/menu', $data1);
        $this->load->view('admin/inputkendaraan');
    }
...
function inputkaroseri()
{
    ...
    $this->load->view('admin/head');
    $this->load->view('admin/menu',$data1);
    $this->load->view('admin/inputkaroseri');
}
