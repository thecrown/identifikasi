					...
					<div class="span12">
						<div class="box box-color box-bordered">
							...
							<div class="box-content">
								<form action="<?php echo base_url();?>index.php/operator/simpaneditkaroseri" method="POST" class='form-horizontal form-validate' id="bb">
								<?php echo form_hidden('id',$edit->id)?>
									  <div class="control-group">
											<label for="textfield" class="control-label">Nama Karoseri</label>
											<div class="controls">
											<input type="text" value="<?php echo $edit->nama_karoseri?>" name="namakaroseri" id="textfield" class="input-xlarge" data-rule-required="true" data-rule-minlength="2">
										    </div>
										</div>
										 <div class="control-group">
											<label for="textfield" class="control-label">Nama Pimpinan</label>
											<div class="controls">
											<input type="text"  value="<?php echo $edit->pemilik?>" name="namapimpinan" id="textfield" class="input-xlarge" data-rule-required="true" data-rule-minlength="2">
										    </div>
										</div>
										<div class="control-group">
											<label for="textfield" class="control-label">Alamat Karoseri</label>
											<div class="controls">
											<textarea name='alamat' class='span8' rows='2'><?php echo $edit->alamat?></textarea>
										    </div>
										</div>
										<div class="control-group">
											<label for="textfield" class="control-label">Nomor Telepon</label>
											<div class="controls">
											<input type="text" value="<?php echo $edit->telp?>" name="notelp" id="textfield" class="input-xlarge" data-rule-required="true" data-rule-minlength="2">
										    </div>
										</div>
										<div class="control-group">
