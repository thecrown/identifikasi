						...
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3>
									...
									Edit Data  Perhitungan Berat Karoseri
								</h3>
							</div>
							<div class="box-content">
							   <form action="<?php echo base_url();?>index.php/operator/simpaneditprosesperhitungan" method="POST" class='form-horizontal form-validate' id="bb">
						        ...
						        <table class="table table-hover table-nomargin table-striped">
												...
												<div class="controls">
													<div class="input-xlarge">
													    <select name="sisi" id="sisi" class='chosen-select'>
													     <option value="<?php echo $edit1->posisi;?>"><?php echo $edit1->posisi;?></option>
										...
										else if ($edit->jenis_kendaraan=='Tangki Bahan Cair' or $edit1->jenis_kendaraan=='Tangki Bahan Gas')
										{
										?>
											<div class="control-group">
											  <label for="textfield" class="control-label">Posisi Part</label>
											...
											<label for="textfield" class="control-label">Nama Komponen Bagian</label>
											    <div class="controls">
													<div class="input-xlarge">
													    ...
													    <option value="<?php echo $edit1->jenis;?>"><?php echo $edit1->jenis;?></option>
													    <option value="">Pilih Salah Satu</option>
						                    	              <?php
											...
											<label for="textfield" class="control-label">Jenis</label>
											    <div class="controls">
													<div class="input-xlarge"><select name="kategori" id="kat_dinding_dpn" class='chosen-select'>
													 <option value="<?php echo $edit1->kategori;?>"><?php echo $edit1->kategori;?></option>
													<option value="">Pilih Salah Satu</option>
						                    	    <?php 
										...
										<div class="control-group">
											...
											<select name="namabahan" id="bahan_dinding_dpn" class='chosen-select'>
													 <option value="<?php echo $edit1->namabahan;?>"><?php echo $edit1->namabahan;?></option>
													<option value="">Pilih Salah Satu</option>
						                    	    <?php 
										 ...
										 <div class="control-group">
												...
												<div class="controls"><input type="text"value="<?php echo $edit1->jumlah;?>" name="jumlah" id="textfield0" class="input-mini"placeholder="Jumlah" data-rule-required="true" data-rule-minlength="1"></div>
										</div>
										<div class="control-group">
											<label for="textfield" class="control-label">Dimensi</label>
											    <p><div class="controls"><input type="text"value="<?php echo $edit1->pj;?>" name="pj" id="textfield1" class="input-mini" placeholder="Panjang" data-rule-required="true" data-rule-minlength="1">  mm</div> 
											    <p><div class="controls"><input type="text"value="<?php echo $edit1->lb;?>" name="lb" id="textfield2" class="input-mini" placeholder="Lebar" data-rule-required="true" data-rule-minlength="1"> mm </div> 
											    <p><div class="controls"><input type="text"value="<?php echo $edit1->tb;?>" name="tb" id="textfield3" class="input-mini" placeholder="Tebal" data-rule-required="true" data-rule-minlength="1"> mm</div> 
											     <p><div class="controls"><input type="text"value="<?php echo $edit1->dimensi;?>" name="dim" id="textfield5" class="input-mini" placeholder="Diameter" data-rule-required="true" data-rule-minlength="1"> mm</div> 
				                        </div>
										<div class="control-group">
											<label for="textfield" class="control-label">Ukuran</label>
											<div class="controls"><input type="text"value="<?php echo $edit1->ukuran;?>" name="ukuran" id="textfield4" class="input-small"placeholder="Ukuran" data-rule-required="true" data-rule-minlength="1"> mm </div>
										</div>
