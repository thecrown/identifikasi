					...
					<div class="span12">
						<div class="box box-color box-bordered">
							...
							<div class="box-content">
								<form action="<?php echo base_url();?>index.php/operator/simpaneditjeniskendaraan" method="POST" class='form-horizontal form-validate' id="bb">
								<?php echo form_hidden('id',$edit->id)?>
									  <div class="control-group">
											<label for="textfield" class="control-label">Jenis Kendaraan</label>
											<div class="controls">
											<input type="text" value="<?php echo $edit->nama_kendaraan?>" name="kendaraan" id="textfield" class="input-xlarge" data-rule-required="true" data-rule-minlength="2">
										    </div>
										</div>
