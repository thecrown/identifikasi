								...
								<?php echo form_hidden('id',$edit->id)?>
									  <div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text"value="<?php echo $edit->massajenis?>" name="massajenissparepart" id="textfield" class="input-small" data-rule-required="true" data-rule-minlength="1"> Kg
										    </div>
