					...
					<div class="span12">
						<div class="box box-color box-bordered">
							...
							<div class="box-content">
								<form action="<?php echo base_url();?>index.php/operator/simpankategori" method="POST" class='form-horizontal form-validate' id="bb">
									  <div class="control-group">
											<label for="textfield" class="control-label">Nama Jenis Part</label>
											<div class="controls">
											<input type="text" name="kategori" id="textfield" class="input-xlarge" data-rule-required="true" data-rule-minlength="2">
										    </div>
										</div>
